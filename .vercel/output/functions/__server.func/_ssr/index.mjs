...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DzEqv_Wm.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-cA06uPvp.mjs").then((n2) => n2.g),
...
export {
  requireReact as $,
  findFlatMatch as A,
  functionalUpdate as B,
  findRouteMatch as C,
  DEFAULT_PROTOCOL_ALLOWLIST as D,
  isPromise as E,
  invariant as F,
  rootRouteId as G,
  executeRewriteOutput as H,
  arraysEqual as I,
  reactExports as J,
  dummyMatchContext as K,
  matchContext as L,
  isModuleNotFoundError as M,
  isServer as N,
  trimPathLeft as O,
  joinPaths as P,
  exactPathTest as Q,
  ...
  React as a0,
  index as a1,
  composeRewrites as b,
  compileDecodeCharMap as c,
  processRouteMasks as d,
  resolvePath as e,
  cleanPath as f,
  trimPathRight as g,
