import { u as useRouter, j as jsxRuntimeExports, c as compileDecodeCharMap, a as createLRUCache, t as trimPath, r as rewriteBasepath, b as composeRewrites, p as processRouteTree, d as processRouteMasks, e as resolvePath, f as cleanPath, g as trimPathRight, h as createControlledPromise, i as parseHref, k as executeRewriteInput, l as isDangerousProtocol, m as redirect, n as isRedirect, o as isNotFound, q as findSingleMatch, s as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, v as interpolatePath, w as nullReplaceEqualDeep, x as replaceEqualDeep, y as last, z as decodePath, A as findFlatMatch, B as functionalUpdate, C as findRouteMatch, E as isPromise, F as invariant, G as rootRouteId, H as executeRewriteOutput, I as arraysEqual, R as React2, J as reactExports, K as dummyMatchContext, L as matchContext, M as isModuleNotFoundError, N as isServer, O as trimPathLeft, P as joinPaths, Q as exactPathTest, S as removeTrailingSlash, T as encodePathLikeUrl, U as requireReactDom, V as Outlet, W as escapeHtml, X as getAssetCrossOrigin, Y as useHydrated, Z as getDefaultExportFromCjs, _ as resolveManifestAssetLink } from "./index.mjs";
import "node:events";
...
function toJsonBody(body) {
  if (body === void 0 || body === null || body instanceof FormData || typeof body !== "object") {
    return body;
  }
...
function readApiError(error, fallback = "Ocurrió un error") {
...
const api = {
    ...
    async refresh() {
      if (!refreshPromise) {
        refreshPromise = request(
          ...
          { method: "POST" },
          { requiresAuth: false, retryOnUnauthorized: false }
        ).then((session) => setSession(session)).catch(() => setSession(null)).finally(() => {
          refreshPromise = null;
        });
      }
  ...
  teams: {
    ...
    createPlayer(code, input) {
      return request(`/teams/${code}/players`, {
        method: "POST",
        body: input
      });
    },
    updatePlayer(code, playerId, input) {
      return request(`/teams/${code}/players/${playerId}`, {
        method: "PATCH",
        body: input
      });
    }
  ...
  matches: {
    ...
    updateStatus(id, status) {
      return request(`/matches/${id}/status`, {
        method: "PATCH",
        body: { status }
      });
    },
    updateParticipants(id, input) {
      return request(`/matches/${id}/participants`, {
        method: "PATCH",
        body: input
      });
    },
    updateResult(id, result) {
      return request(`/matches/${id}/result`, {
        method: "PATCH",
        body: result
      });
    },
  ...
  predictions: {
    mine() {
      return request("/predictions/me", { method: "GET" });
    },
    upsert(matchId, prediction) {
  ...
  specialPredictions: {
    mine() {
      return request("/special-predictions/me", { method: "GET" });
    },
    upsert(prediction) {
      return request("/special-predictions/me", {
        method: "PUT",
        body: prediction
      });
    }
...
const PredictionsContext = reactExports.createContext(null);
function PredictionsProvider({ children }) {
  ...
  const [specialPredictions, setSpecialPredictions] = reactExports.useState([]);
  const [teamsLoading, setTeamsLoading] = reactExports.useState(true);
  const [matchesLoading, setMatchesLoading] = reactExports.useState(true);
  const [privateLoading, setPrivateLoading] = reactExports.useState(false);
  reactExports.useEffect(() => {
    let active = true;
  ...
  const getPrediction = (matchId, userId) => predictions.find((p) => p.matchId === matchId && p.userId === userId);
  ...
  const getSpecialPrediction = (userId) => specialPredictions.find((p) => p.userId === userId);
  const saveSpecialPrediction = async (p) => {
    if (user?.role === "admin") {
  ...
  const resolveMatchParticipants = async (id, input) => {
...
function usePredictions() {
  const ctx = reactExports.useContext(PredictionsContext);
...
const appCss = "/assets/styles-BclYq5fN.css";
const faviconLogo = "/assets/world-cup-2026-mark-CoyQmIKT.png";
...
const Route$b = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Balero World Cup" },
      { name: "description", content: "Predicciones del Mundial de Fútbol — Balero World Cup" },
      { name: "author", content: "Balero" },
      { property: "og:title", content: "Balero World Cup" },
      { property: "og:description", content: "Predicciones del Mundial de Fútbol" },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PredictionsProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { position: "top-right", richColors: true })
  ] }) });
}
const $$splitComponentImporter$a = () => import("./teams-DkEWMMcs.mjs");
const Route$a = createFileRoute("/teams")({
  head: () => ({
    meta: [{
      title: "Equipos del Mundial — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./special-BaRzk4-Y.mjs");
const Route$9 = createFileRoute("/special")({
  head: () => ({
    meta: [{
      title: "Mi pronóstico — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./scorers-Bm93AYir.mjs");
const Route$8 = createFileRoute("/scorers")({
  head: () => ({
    meta: [{
      title: "Máximos goleadores — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./register-Dk4LLM0s.mjs");
const Route$7 = createFileRoute("/register")({
  head: () => ({
    meta: [{
      title: "Crear cuenta — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./ranking-DS0l7zLS.mjs");
const Route$6 = createFileRoute("/ranking")({
  head: () => ({
    meta: [{
      title: "Ranking — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./login-BR4isGzw.mjs");
const Route$5 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Iniciar sesión — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./calendar-D2Wb3N2L.mjs");
const Route$4 = createFileRoute("/calendar")({
  head: () => ({
    meta: [{
      title: "Calendario — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin-BOqcjBzA.mjs");
const Route$3 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "Admin — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-BA0vSuL9.mjs");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "Dashboard — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./teams._teamCode-C6tAhyNW.mjs");
const Route$1 = createFileRoute("/teams/$teamCode")({
  head: () => ({
    meta: [{
      title: "Plantel de selección — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./match._matchId-BB2ju97w.mjs");
const Route2 = createFileRoute("/match/$matchId")({
  head: () => ({
    meta: [{
      title: "Predicción — Balero World Cup"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TeamsRoute = Route$a.update({
  id: "/teams",
  path: "/teams",
  getParentRoute: () => Route$b
});
const SpecialRoute = Route$9.update({
  id: "/special",
  path: "/special",
  getParentRoute: () => Route$b
});
const ScorersRoute = Route$8.update({
  id: "/scorers",
  path: "/scorers",
  getParentRoute: () => Route$b
});
...
const RankingRoute = Route$6.update({
  id: "/ranking",
  path: "/ranking",
  getParentRoute: () => Route$b
});
...
const TeamsTeamCodeRoute = Route$1.update({
  id: "/$teamCode",
  path: "/$teamCode",
  getParentRoute: () => TeamsRoute
});
const MatchMatchIdRoute = Route2.update({
  id: "/match/$matchId",
  path: "/match/$matchId",
  getParentRoute: () => Route$b
});
