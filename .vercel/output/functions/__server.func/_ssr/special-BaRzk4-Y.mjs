...
import { a as useAuth, u as usePredictions, L as Link, b as useNavigate, t as toast } from "./router-B1kSKAf9.mjs";
import { A as AuthGuard, L as Label } from "./label-DWX2Ekou.mjs";
import { H as Header, S as Star } from "./Header-ujJFDq-9.mjs";
import { i as isSpecialPredictionLocked, a as isWorldCupStarted, t as timeUntilSpecialDeadline, L as Lock } from "./scoring-Cu5wh4ZA.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden p-4 shadow-[var(--shadow-elegant)] animate-slide-up sm:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Campeón, goleador y final. Editable hasta 1 día antes del Mundial." })
        ] })
      ] }),
      !locked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 rounded-xl border border-primary/30 bg-primary/5 px-4 py-3 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: "Cierre: 10 de junio de 2026" })
      ] }),
      locked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-start gap-3 rounded-xl border border-destructive/30 bg-destructive/10 px-4 py-3 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive/80", children: started ? "El Mundial ya comenzó. Solo podés predecir los partidos del día." : "El plazo para modificar ya cerró." })
        ] })
      ] }),
