import { u as useRouter, J as reactExports, j as jsxRuntimeExports, $ as requireReact } from "./index.mjs";
import { a as useAuth, b as useNavigate, L as Link, t as toast } from "./router-cA06uPvp.mjs";
import { B as BrandLogo } from "./BrandLogo-_Uc-xGk_.mjs";
import { B as Button, I as Input, b as composeRefs, c as cn, u as useComposedRefs, d as createSlot$2 } from "./input-CBQLwIGd.mjs";
import { c as createLucideIcon, u as useControllableState, a as useId, P as Primitive$1, b as composeEventHandlers, d as useCallbackRef$1, e as useDirection, R as Root2$1, f as Anchor, g as Portal$2, h as createContextScope$1, i as createPopperScope, j as hideOthers, k as createCollection, l as dispatchDiscreteCustomEvent, m as useLayoutEffect2, n as ReactRemoveScroll, o as useFocusGuards, F as FocusScope, D as DismissableLayer, C as Content$1, p as createContext2, q as Arrow, r as Check } from "./check-CUGRap4B.mjs";
import { L as Label$1 } from "./card-DVycTJf1.mjs";
var shim = { exports: {} };
...
const Medal = createLucideIcon("medal", __iconNode$5);
const __iconNode$4 = [
...
function Header() {
  ...
  const navItems = [
    ...
    ...!isAdmin ? [{ to: "/special", label: "Mi pronóstico", icon: Star }] : [],
    { to: "/ranking", label: "Ranking", icon: Medal },
    ...isAdmin ? [{ to: "/admin", label: "Admin", icon: Shield }] : []
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-white/35 bg-background/72 shadow-[0_10px_32px_-28px_rgba(5,24,44,0.8)] backdrop-blur-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex min-h-14 max-w-7xl items-center justify-between gap-2 px-3 py-1.5 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex min-w-0 items-center gap-2 text-base font-bold sm:text-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        BrandLogo,
        {
          size: "sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-0.5 lg:flex", children: navItems.map((item) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            to: item.to,
            className: `flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-semibold transition-colors xl:px-3 ${active ? "bg-primary/12 text-primary-deep shadow-inner" : "text-muted-foreground hover:bg-secondary/75 hover:text-foreground"}`,
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-shrink-0 items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "icon", className: "h-8 w-8 lg:hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Abrir navegación" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: "Navegación" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
            navItems.map((item) => {
              const Icon = item.icon;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: item.to, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden rounded-md border border-primary/15 bg-white/40 px-2 py-1 text-right sm:block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Puntos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold text-primary-deep", children: [
            user.points,
            " pts"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded-full ring-offset-background transition-all hover:ring-2 hover:ring-primary hover:ring-offset-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-9 w-9 border-2 border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-[var(--gradient-primary)] font-semibold text-primary-foreground", children: user.avatar }) }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-56", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: user.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-normal text-muted-foreground", children: user.email }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-1 text-xs font-bold text-primary", children: [
                user.points,
                " puntos"
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { className: "mr-2 h-4 w-4" }),
              "Dashboard"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/teams", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "mr-2 h-4 w-4" }),
              "Equipos"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/scorers", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "mr-2 h-4 w-4" }),
              "Goleadores"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/calendar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "mr-2 h-4 w-4" }),
              "Calendario"
            ] }) }),
            !isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/special", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "mr-2 h-4 w-4" }),
              "Mi pronóstico"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ranking", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { className: "mr-2 h-4 w-4" }),
              "Ranking"
            ] }) }),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: pwOpen, onOpenChange: setPwOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Cambiar contraseña" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleChangePw, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Contraseña actual" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Nueva contraseña" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", children: "Actualizar" }) })
      ] })
    ] }) })
  ] });
}
